...
\subsection{Project organization} %timeline
...
\subsection{Participant direction} %blackboard
...
\subsection{Team-based approach} %adm
...
\subsection{Collaboration and feedback} %supervisor
