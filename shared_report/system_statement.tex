...
There are several ways to decomposition \system{} to integrate the core principles of Aalborg PBL in Moodle. 
...
Each sub-system along are described in the following sections. %with their relation to the core principles will now be described.
