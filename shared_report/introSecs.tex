...
This observation has lead us to investigate how the method of our university, the PBL \emph{(problem based learning)} Model, can be implemented into the e-learning system being used at our university.
...
In this part ``we'' refer to all 14 members of the multi-project.
...
This project is to be concerned with how to implement support for the Aalborg PBL Model in Moodle. 
