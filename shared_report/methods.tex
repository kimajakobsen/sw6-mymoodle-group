...
\paragraph{Scrum} \todo{Mangler kilder til hele scrum delen}
...
\paragraph{Waterfall} \todo{Bestem hvilken waterfall metode vi vil beskrive}
A project following the Waterfall method is divided into a number of phases.
The number of phases in a Waterfall development process is not exact.\todo{Beskriv en bestem metode}
...
The following list shows the characteristics of this project that will be used to determine the development method which should be used. \todo{Disse skal forklares mere uddybende, med 2 linjer hver.}
\begin{enumerate}
...
In short, the personnel factor covers the composition of personnel based on the on the \textit{extended Cockburn method skill rating scale}, where people are divided into five categories based on the methodological skills, namely levels -1, 1b, 1a, 2, and 3.
...
Scrum of Scrums\todo{kilde om hvad sos er} dictates that there should be a Scrum master in each subgroup.
